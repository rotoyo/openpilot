  ...
  def read_config(self):
    ...
    if os.path.isfile('/data/kegman.json'):
      ...
      if "wheelTouchSeconds" not in self.config:
        self.config.update({"wheelTouchSeconds":"70"})
        self.element_updated = True		
      ...
      self.config = {"cameraOffset":"0.04", "lastTrMode":"1", "battChargeMin":"70", "battChargeMax":"80", \
                     "wheelTouchSeconds":"70", "battPercOff":"100", "carVoltageMinEonShutdown":"11800", \
